...
main (int argc, char *argv[])
{
  ...
  routerLink.EnableAsciiAll (ascii.CreateFileStream ("/home/vipulharsh/jellyfish/ns3/ntu-nsi-dcn-forked/statistics/try" + systemId_s + ".tr"));
  //routerLink.EnablePcapAll ("/home/vipulharsh/jellyfish/ns3/ntu-nsi-dcn-forked/statistics/ascii_logs/distributedy" + systemId_s);
